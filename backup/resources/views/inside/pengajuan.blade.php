            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="date" name="group[start_date]" class="form-control pull-right" id="reservation" placeholder="Masukkan Tanggal Mulai Berlaku (yyyy-mm-dd)" required>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="date" name="group[end_date]" class="form-control pull-right" id="reservation" placeholder="Masukkan Tanggal Mulai Berlaku (yyyy-mm-dd)" required>
                </div>
              </div>
            </div>
            <div class="col-md-4">
